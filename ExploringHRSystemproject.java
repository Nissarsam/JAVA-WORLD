...
public class ExploringHRSystemproject {
    ...
    public static void main(String[] args) {
        ...
        SalesRep rep1 = projectInstance.new SalesRep("Nissar", "N", 3037, 22, 200, 5, 35000, 2, 100000);
        SalesManager manager = projectInstance.new SalesManager("Farooq", "V", 5059, 22, 100, 50, 50000, 5);

        // Add SalesRep to the team
        manager.addToTeam(rep1);

        // Display information for SalesRep (Nissar)
        System.out.println("Nissar time to retirement: " + rep1.timeToRetirement());
        System.out.println("Nissar vacation time left: " + rep1.vacationTimeLeft());
        System.out.println("Nissar bonus: " + rep1.calculateBonus());
        System.out.println("Nissar commission: " + rep1.calculateCommission());

        // Display information for SalesManager (Farooq)
        System.out.println("Farooq time to retirement: " + manager.timeToRetirement());
        System.out.println("Farooq vacation time left: " + manager.vacationTimeLeft());
        System.out.println("Farooq bonus: " + manager.calculateBonus());
